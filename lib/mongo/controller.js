...
let ProductsController = class ProductsController extends odata_v4_server_1.ODataController {
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return db.collection("Products").find(mongodbQuery.query, mongodbQuery.projection, mongodbQuery.skip, mongodbQuery.limit).sort(mongodbQuery.sort).toArray();
        });
    }
    findOne(key, query) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    discountProduct(productId, percent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield db.collection("Products").update({ _id: new mongodb_1.ObjectID(productId) }, { $set: { UnitPrice: discountedPrice } });
        });
    }
};
__decorate([
...
let CategoriesController = class CategoriesController extends odata_v4_server_1.ODataController {
    find(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof mongodbQuery.query._id == "string")
                mongodbQuery.query._id = new mongodb_1.ObjectID(mongodbQuery.query._id);
            return db.collection("Categories").find(mongodbQuery.query, mongodbQuery.projection, mongodbQuery.skip, mongodbQuery.limit).sort(mongodbQuery.sort).toArray();
        });
    }
    findOne(key, query) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getProducts(result, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof mongodbQuery.query.CategoryId == "string")
                mongodbQuery.query.CategoryId = new mongodb_1.ObjectID(mongodbQuery.query.CategoryId);
            return db.collection("Products").find({ $and: [{ CategoryId: result._id }, mongodbQuery.query] }, mongodbQuery.projection, mongodbQuery.skip, mongodbQuery.limit).sort(mongodbQuery.sort).toArray();
        });
    }
