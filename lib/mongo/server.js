...
let NorthwindServer = class NorthwindServer extends odata_v4_server_1.ODataServer {
    initDb() {
        return __awaiter(this, void 0, void 0, function* () {
            const db = yield connection_1.default();
            yield db.dropDatabase();
            yield db.collection("Categories").insertMany(categories_1.default);
            yield db.collection("Products").insertMany(products_1.default);
        });
    }
};
__decorate([
...
NorthwindServer = __decorate([
    odata_v4_server_1.odata.namespace("NorthwindTS"),
