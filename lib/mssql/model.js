...
let Product = class Product {
    ...
    invertDiscontinued(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield db.collection('Products').findOneAndUpdate({ Id: result.Id }, { $set: { Discontinued: !result.Discontinued } });
        });
    }
    setDiscontinued(result, value) {
        return __awaiter(this, void 0, void 0, function* () {
            //let db = await mongodb();
            let db = yield connection_1.default();
            yield db.collection('Products').findOneAndUpdate({ Id: result.Id }, { $set: { Discontinued: value } });
        });
    }
};
__decorate([
