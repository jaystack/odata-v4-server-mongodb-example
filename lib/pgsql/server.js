...
const multipleInsert_1 = require("./utils/multipleInsert");
let NorthwindServer = class NorthwindServer extends odata_v4_server_1.ODataServer {
    initDb() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield multipleInsert_1.default(db, "Categories", categories_1.default);
            yield multipleInsert_1.default(db, "Products", products_1.default);
        });
    }
};
__decorate([
