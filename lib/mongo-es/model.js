...
var _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _dec16, _dec17, _dec18, _dec19, _dec20, _dec21, _dec22, _dec23, _dec24, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _dec25, _dec26, _dec27, _dec28, _dec29, _dec30, _dec31, _dec32, _dec33, _dec34, _class4, _desc2, _value2, _class5, _descriptor8, _descriptor9, _descriptor10, _descriptor11;
...
let Product = exports.Product = (_dec = _odataV4Server.Edm.Annotate({
    term: "UI.DisplayName",
    string: "Products"
    ...
    term: "UI.ControlHint",
    string: "Decimal"
}), _dec17 = _odataV4Server.Edm.Function, _dec18 = _odataV4Server.Edm.Decimal, _dec19 = _odataV4Server.odata.parameter("result", _odataV4Server.odata.result), _dec20 = _odataV4Server.Edm.Action, _dec21 = _odataV4Server.odata.parameter("result", _odataV4Server.odata.result), _dec22 = _odataV4Server.Edm.Action, _dec23 = _odataV4Server.odata.parameter("result", _odataV4Server.odata.result), _dec24 = _odataV4Server.odata.parameter("value", _odataV4Server.Edm.Boolean), _dec(_class = (_class2 = class Product {
    constructor() {
    ...
    enumerable: true,
    initializer: null
}), _applyDecoratedDescriptor(_class2.prototype, "getUnitPrice", [_dec17, _dec18, _dec19], Object.getOwnPropertyDescriptor(_class2.prototype, "getUnitPrice"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "invertDiscontinued", [_dec20, _dec21], Object.getOwnPropertyDescriptor(_class2.prototype, "invertDiscontinued"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setDiscontinued", [_dec22, _dec23, _dec24], Object.getOwnPropertyDescriptor(_class2.prototype, "setDiscontinued"), _class2.prototype)), _class2)) || _class);
let Category = exports.Category = (_dec25 = _odataV4Server.Edm.Annotate({
    term: "UI.DisplayName",
    string: "Categories"
}), _dec26 = _odataV4Server.Edm.Key, _dec27 = _odataV4Server.Edm.Computed, _dec28 = _odataV4Server.Edm.String, _dec29 = _odataV4Server.Edm.Annotate({
    term: "UI.DisplayName",
    string: "Category identifier"
}, {
    term: "UI.ControlHint",
    string: "ReadOnly"
}), _dec30 = _odataV4Server.Edm.String, _dec31 = _odataV4Server.Edm.String, _dec32 = _odataV4Server.Edm.Annotate({
    term: "UI.DisplayName",
    string: "Category name"
}, {
    term: "UI.ControlHint",
    string: "ShortText"
}), _dec33 = _odataV4Server.Edm.Collection(_odataV4Server.Edm.EntityType("Product")), _dec34 = _odataV4Server.Edm.Partner("Category"), _dec25(_class4 = (_class5 = class Category {
    constructor() {
...
}, (_descriptor8 = _applyDecoratedDescriptor(_class5.prototype, "_id", [_dec26, _dec27, _dec28, _dec29], {
    enumerable: true,
    initializer: null
}), _descriptor9 = _applyDecoratedDescriptor(_class5.prototype, "Description", [_dec30], {
    enumerable: true,
    initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class5.prototype, "Name", [_dec31, _dec32], {
    enumerable: true,
    initializer: null
}), _descriptor11 = _applyDecoratedDescriptor(_class5.prototype, "Products", [_dec33, _dec34], {
    enumerable: true,
    initializer: null
})), _class5)) || _class4);