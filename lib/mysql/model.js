...
let Product = class Product {
    ...
    invertDiscontinued(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield connection.query(`UPDATE Products SET Discontinued = ? WHERE Id = ? `, [!result.Discontinued, result.Id]);
        });
    }
    setDiscontinued(result, value) {
        return __awaiter(this, void 0, void 0, function* () {
            const connection = utils_1.promisifyWithDbName(yield connection_1.default());
            return yield connection.query(`UPDATE Products SET Discontinued = ? WHERE Id = ? `, [value, result.Id]);
        });
    }
};
__decorate([
...
__decorate([
    odata_v4_server_1.Edm.EntityType("NorthwindMySQL.Category"),
...
__decorate([
    odata_v4_server_1.Edm.Action,
    __param(0, odata_v4_server_1.odata.result), __param(1, odata_v4_server_1.Edm.Boolean)
], Product.prototype, "setDiscontinued", null);
Product = __decorate([
    odata_v4_server_1.odata.namespace("NorthwindMySQL"),
    odata_v4_server_1.Edm.Annotate({
        term: "UI.DisplayName",
        string: "Products"
    })
...
__decorate([
    odata_v4_server_1.Edm.Collection(odata_v4_server_1.Edm.EntityType("NorthwindMySQL.Product")),
