...
let Product = class Product {
    ...
    invertDiscontinued(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const updateResults = yield connection.query(`UPDATE Products SET Discontinued = ? WHERE Id = ? `, [!result.Discontinued, result.Id]);
            return utils_1.mapDiscontinued(updateResults);
        });
    }
    setDiscontinued(result, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const connection = utils_1.promisifyWithDdName(yield connection_1.default());
            const updateResults = yield connection.query(`UPDATE Products SET Discontinued = ? WHERE Id = ? `, [value, result.Id]);
            return utils_1.mapDiscontinued(updateResults);
        });
    }
};
