...
let ProductsController = class ProductsController extends odata_v4_server_1.ODataController {
    ...
    insert(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const connection = utils_1.promisifyWithDbName(yield connection_1.default());
            const result = yield connection.query(`INSERT INTO Products VALUES (?,?,?,?,?,?);`, [data.Id, data.QuantityPerUnit, data.UnitPrice, data.CategoryId, data.Name, data.Discontinued]);
...
let CategoriesController = class CategoriesController extends odata_v4_server_1.ODataController {
    ...
    insert(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const connection = utils_1.promisifyWithDbName(yield connection_1.default());
            const result = yield connection.query(`INSERT INTO Categories VALUES (?,?,?);`, [data.Id, data.Description, data.Name]);
