...
function createTest(testcase, command, compare, body) {
    it(`${testcase} (${command})`, () => {
        ...
        return server_1.NorthwindServer.execute(test.slice(1).join(" "), test[0], body).then((result) => {
...
describe("OData V4 MongoDB example server", () => {
    beforeEach(() => {
        return server_1.NorthwindServer.execute("/initDb", "POST");
    });
    describe("Products", () => {
        ...
        it("should create new product", () => {
            return server_1.NorthwindServer.execute("/Products", "POST", {
                Name: "New product",
                CategoryId: categories[0]._id
            }).then((result) => {
                expect(result.body._id instanceof mongodb_1.ObjectID).to.be.true;
        ...
        it("should update product", () => {
            return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')", "PUT", {
                Name: "Chai (updated)"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')", "GET").then((result) => {
                    expect(result).to.deep.equal({
                        statusCode: 200,
                        body: {
                            "@odata.context": "http://localhost/$metadata#Products/$entity",
        ...
        it("should delta update product", () => {
            return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')", "PATCH", {
                Name: "Chai (updated)"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
        ...
        it("should delete product", () => {
            return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')", "DELETE").then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')", "GET").then(() => {
        ...
        it("should create category reference on product", () => {
            return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')/Category/$ref", "POST", {
                "@odata.id": "http://localhost/Categories('578f2baa12eaebabec4af28a')"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')/Category", "GET").then((result) => {
                    expect(result).to.deep.equal({
                        statusCode: 200,
                        body: extend({
                            "@odata.context": "http://localhost/$metadata#Categories/$entity"
        ...
        it("should update category reference on product", () => {
            return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')/Category/$ref", "PUT", {
                "@odata.id": "http://localhost/Categories('578f2baa12eaebabec4af28a')"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
        ...
        it("should delete category reference on product", () => {
            return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')/Category/$ref", "DELETE").then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')/Category", "GET").then((result) => {
    ...
    describe("Categories", () => {
        ...
        it("should create new category", () => {
            return server_1.NorthwindServer.execute("/Categories", "POST", {
                Name: "New category",
        ...
        it("should update category", () => {
            return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af289')", "PUT", {
                Name: "Beverages (updated)"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af289')", "GET").then((result) => {
                    expect(result).to.deep.equal({
                        statusCode: 200,
                        body: {
                            "@odata.context": "http://localhost/$metadata#Categories/$entity",
        ...
        it("should delta update category", () => {
            return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af289')", "PATCH", {
                Name: "Beverages (updated)"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
        ...
        it("should delete category", () => {
            return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af289')", "DELETE").then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af289')", "GET").then(() => {
                    throw new Error("Product should be deleted.");
                }, (err) => {
                    expect(err.name).to.equal("ResourceNotFoundError");
                });
        ...
        it("should create product reference on category", () => {
            return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af28a')/Products/$ref", "POST", {
                "@odata.id": "http://localhost/Products('578f2b8c12eaebabec4af23c')"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
        ...
        it("should update product reference on category", () => {
            return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af28a')/Products/$ref", "PUT", {
                "@odata.id": "http://localhost/Products('578f2b8c12eaebabec4af23c')"
            }).then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
        ...
        it("should delete product reference on category", () => {
            return server_1.NorthwindServer.execute("/Categories('578f2baa12eaebabec4af289')/Products/$ref?$id=http://localhost/Products('578f2b8c12eaebabec4af23c')", "DELETE").then((result) => {
                expect(result).to.deep.equal({
                    statusCode: 204
                });
                return server_1.NorthwindServer.execute("/Products('578f2b8c12eaebabec4af23c')/Category", "GET").then((result) => {
